...
path = "/home/biorobotics/cpp_test/CameraCalibration/arucoBoard"
...
markerLength = 40.02  # Here, measurement unit is centimetre.

# Provide separation between markers
markerSeparation = 4.99   # Here, measurement unit is centimetre.
...
if Calibrate_camera == True:
    ...
    np.savez ("B5Aruco", mtx = mtx, dist = dist)
